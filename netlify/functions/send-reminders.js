...
// Scheduled function — runs at 5:00 AM SAST (3:00 AM UTC)
...
exports.handler = async () => {
  ...
  try {
    ...
    // Morning only — classes before 12:00
    ...
    if (filtered.length === 0) {
      console.log('No morning bookings today');
      return { statusCode: 200, body: 'No morning bookings today' };
    }
    ...
    console.log(`Morning reminders — sent: ${sent}, failed: ${failed}`);
